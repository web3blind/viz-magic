...
HP не восстанавливается до максимума автоматически. Пассивная регенерация возвращает до **30% от максимума HP** (+1 HP каждые 500 блоков, ~4 мин). Полное восстановление: зайди на экран Охоты (отдых в лагере) или используй **Свиток Здоровья** (крафтится или падает с существ).
