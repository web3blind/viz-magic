...
var LeaderboardScreen = (function() {
    ...
    function _renderFromSnapshot(snapshot) {
        ...
        if (!rows.length) {
            el.innerHTML =
                '<div class="screen-header"><h2><span class="screen-title-icon section-icon vmagic-breathe leaderboard-title-icon" aria-hidden="true">🏆</span> ' + t('leaderboard_title') + '</h2></div>' +
                statusHtml +
        ...
        el.innerHTML =
            '<div class="screen-header">' +
                '<h2 id="leaderboard-heading"><span class="screen-title-icon section-icon vmagic-breathe leaderboard-title-icon" aria-hidden="true">🏆</span> ' + t('leaderboard_title') + '</h2>' +
            '</div>' +
            rankBanner +
            statusHtml +
