...
var LangEN = {
    ...
    map_lore_commons_first_light: 'The road begins at a warm hearth. A trail of glowing stones winds through a meadow where young mages wake at dawn. Left stands a low tavern with a bird-sign, smoke curling from its chimney; right, a wooden training tower with a cat dozing on its steps. Pale hills roll in the distance, streams run between them, and three hot-air balloons — red, blue and yellow — circle overhead like drops on a map.',
    map_lore_covenant_bazaar: 'A neutral bazaar under striped awnings. Stalls overflow with goods: gems in baskets, scrolls, potion flasks, fabrics and strange machines. Ropes of paper lanterns hang over the rows; traders in bright turbans beckon buyers. At the center a stone fountain plays with flying coins, and scales and seals line the perimeter. The dotted road threads between stalls, past a camel laden with carpets and a monkey that has stolen an apple.',
    map_lore_deep_currents: 'Coral caves beneath the waves. Blue light filters through the water as shoals of glowing fish circle a sunken mast. In the depths a white coral rises like a castle, circled by a dolphin and a whale that blows bubbles like a fountain. The dotted road dives between columns and shells; at the grotto\'s mouth an octopus with huge eyes waits, and on the seabed lies an old chest spilling pearls.',
    map_lore_duel_spires: 'An arena beneath the spires. Two tall needle-towers join over a stone bridge above a churning river. On the sand-strewn round arena two knights cross blades while a banner bearing a sword ripples above. Shields and torches line the walls; an armor stand waits at the entrance. The dotted path climbs a spiral stair onto the bridge, from which the whole world opens. A griffin circles the sky, and a falcon perches on the spire.',
    map_lore_ember_wastes: 'Wastes of volcanic heat: cracks in the earth breathe crimson, and a pillar of smoke shaped like a dragon rises from the mountain\'s maw. An orange beast with a trunk crawls over scorched stone while a fire-tailed bird wheels above. The dotted road loops between geysers, and on a cliff face a lightning arrow points toward a black fortress with turrets, chained to a rock so it cannot drift away, mirrored in a lake of lava.',
    map_lore_forklands: 'Contested land at the fork: the road splits into five paths, each marked by a signpost with an arrow. Crags are riddled with caves; a windmill with turning vanes stands on a hill. Two riders bearing rival guild flags gallop across the field while a raven circles above. An overturned cart spills ore by the roadside, and campfires smoke far off. The dotted path runs through a ford and past an old tree carved with marks.',
    map_lore_iron_root: 'Ancient mines inside the mountain. Iron roots push up from the earth and weave over the vaults; at the entrance stand an ore cart and a pickaxe stuck in stone. Lanterns line the dark gallery, throwing golden circles on walls veined with ore. A dwarf in a pointed cap carries a sack of gems, and deep inside a steam engine waits on the rails, smoke puffing from its boiler. The dotted path crosses bridges over an underground river.',
    map_lore_shattered_sky: 'Floating islands above the clouds. Each island hangs on roots trailing into the sky, joined by rope bridges and ladders. From the highest island a waterfall plunges that never reaches the ground. A dirigible with a checked flag, a flock of white birds, and a lone hot-air balloon drift around — in its basket a traveler waves. The dotted path hops from island to island through arches of cloud.',
    map_lore_the_veil: 'A labyrinth of shadows that moves. Walls shift like smoke, and the dotted road appears and fades. Blue candles burn in niches, casting long shadows on frescoes of spirals. Hooded figures glide through the passages; at the center an old well glows with moonlight at its bottom. A black cat with pale eyes sits at the crossroads and points the way with its paw. Somewhere below shimmers a great mirror-door, chained to the wall.',
    map_level: 'Lv.',
    map_pvp: 'PvP',
