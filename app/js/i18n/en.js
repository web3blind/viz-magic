...
var LangEN = {
    ...
    map_lore_ember_wastes: 'The Wastes of Fire. Crimson cracks breathe heat, smoke curls from the mountain\'s maw, and ember wisps dash about scattering fire dust. Geysers of flame burst from obsidian cliffs where firecasters weave their patterns. At the center of a lava lake rises the black tower of the Ignis mages, reached by a bridge of cooled lava. The dotted path loops between fissures, past forges where red-hot blades are struck, along a beacon whose bonfire is seen for many lands.',
    ...
    map_lore_the_veil: 'The Veil of Shadows. A shifting labyrinth where walls flow like smoke and the dotted road appears and fades. Blue candles burn in niches, casting long shadows on spiraled frescoes; hollow shades — the guardians of Umbra — glide through the passages. At the center a moonlit well glimmers in its depth, and around it lie echo shards and chronicle ink. Somewhere below stands a great mirror-door hiding a secret. The path here remembers every step and chooses where to lead.',
    map_level: 'Lv.',
    map_pvp: 'PvP',
    ...
    help_magic_library_chapter_two_title: 'Magical Library, Chapter Two: Secret Maps of the World',
    help_magic_library_chapter_two_intro: 'This chapter preserves new secret maps: roads, settlements, and impossible incidents absent from the old scrolls.',
    help_magic_library_chapter_two_locked: 'The chapter is sealed. One entry unlocks it permanently for this account.',
    help_magic_library_chapter_two_unlock: 'Unlock chapter for 10% energy',
    help_magic_library_chapter_two_opened: 'Chapter unlocked. All fifteen secret maps are available without another payment.',
    help_magic_library_chapter_two_confirm_title: 'Unlock chapter two?',
    help_magic_library_chapter_two_confirm_text: 'Exactly 10% energy will be spent. After the transaction is confirmed, this account will not be charged again.',
    help_magic_library_chapter_two_confirm: 'Unlock for 10% energy',
    ...
    help_magic_library_chapter_two_already_open: 'An earlier payment was found. Chapter two opened without another charge.',
    help_magic_library_chapter_two_energy_failed: 'Could not check current energy. Please try again.',
    help_magic_library_chapter_two_not_enough: 'At least 10% energy is required to unlock this chapter.',
    help_magic_library_chapter_two_failed: 'The transaction was not confirmed. Energy was not spent or access is not open yet.',
    help_magic_library_chapter_two_success: 'Magical Library chapter two is now unlocked.',
