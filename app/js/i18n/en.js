...
var LangEN = {
    ...
    map_secret_portal: 'A tiny hidden passage at the edge points toward {name}.',
    map_secret_next_unknown: 'an unknown level',
    map_zoom_controls: 'Map zoom controls',
    map_zoom_toggle: 'Zoom map',
    map_zoom_reset: 'Shrink map',
    map_zoom_hint: 'On desktop, use this button or double-click the map.',
    ...
    map_lore_emberheart: 'The Emberheart is not a surface wasteland but the inner forge of a living world. Magma veins run like glowing arteries, obsidian ribs hold the vault, brass canals carry heat, and a crystalline Ignis heart pulses at the centre. The dotted path follows gantries between ribs and furnace gates, past bellows and gold sluices, to an altar where fire beats like a heart.',
    ...
    map_lore_timeless_maze: 'The Timeless Maze is not a shadow veil but a clockwork labyrinth broken into floating islands. Silver-blue rivers of time run between platforms, hourglass bridges link the rings, broken sundials become plazas, and luminous clock faces open short paths. The dotted route leaps from island to island, past pendulums and starry gaps, to a centre where the hands turn in different directions.',
