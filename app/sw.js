...
self.addEventListener('fetch', function(event) {
    ...
    var isLibraryMapImage = (url.pathname.indexOf('/assets/library-maps-v2/') === 0 ||
        ...
        url.pathname.indexOf('/assets/library-maps-middle/') === 0 ||
        url.pathname.indexOf('/assets/library-maps-attraction/') === 0 ||
        url.pathname.indexOf('/assets/library-maps-living-nature/') === 0 ||
        url.pathname.indexOf('/assets/library-maps-living-elements/') === 0 ||
        url.pathname.indexOf('/assets/library-maps-living-forest/') === 0) && /\.(jpg|png)$/.test(url.pathname);
